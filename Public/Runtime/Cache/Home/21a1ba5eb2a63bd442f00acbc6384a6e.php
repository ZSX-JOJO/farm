...
<nav class="breadcrumb" style='height: 45px;line-height: 45px;font-size: 16px;'>添加好友</nav>
<div class="page-container">
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            <span class="l" >
                <button type="button" class="btn btn-success" onclick="showPage('660','218','添加好友','<?php echo U('Member/addfriends');?>')" href="javascript:;"><i class="Hui-iconfont"></i> 添加好友</button>
        ...
        <div class="mt-0">
            <table class="table table-border table-bordered table-hover table-bg ">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c"> 
                        ...
                        <td class="text-c" style="width:180px;"> <a href="javascript:;" onclick="allow(<?php echo ($vo["id"]); ?>)" >允许</a>  <a href="javascript:;" onclick="refuse(<?php echo ($vo["id"]); ?>)" > 拒绝</a></td>
