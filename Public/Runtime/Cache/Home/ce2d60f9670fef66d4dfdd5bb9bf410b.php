...
setInterval(autotime, 30000);  //30秒
});
  ...
  <div class="main"> 
   <div class="bg"> 
    <div class="userinfo" style=""> 
     ...
     <div class="userinfo" style="top:110px"> 
     <img class="yuanbao01" src="/Public/images/home/yuanbao01.png"  title="积分"/> 
     <img class="money01" src="/Public/images/home/money01.png" title="现金" /> 
     <img class="streng01" src="/Public/images/home/streng01.png" title="果实数量"/> 
     <div style="width: 65px;height: 70px;float: left;"> 
      <img style="margin-top:16px;margin-left: 3px" src="/Public/images/home/avater/noavatar_middle.gif" width="55px" height="55px" /> 
      <span style="margin-top: 5px;   display: inline-block;"> <a href="#" style="color: white">[<?php echo ($fuser); ?>]</a> </span> 
     </div> 
     <div style="width: 145px;float: left;line-height: 17px;"> 
      <div id="userinfo">
       <?php echo ($otheruserinfo["username"]); ?>
       <br />
       <span style="position: relative;"> <span id="userlevel"><?php echo ($otherlevel["title"]); ?></span><img src="/Public/images/home/up_alt.png" style=" display:none" /></span>(
       <span id="upexperience"><?php echo ($otheruplevel["experience"]); ?></span>/<span id='experience'><?php echo ($otheruserinfo["experience"]); ?></span>)
      </div> 
      <div style="width: 145px;float: left;"> 
       <div style="height: 30px;margin-left: 28px"> 
        <span id="otherusermoney"><?php echo ($otheruserinfo["principal"]); ?></span>
        <br /> 
        <span id="otherintegral"><?php echo ($otheruserinfo["integral"]); ?></span>
        <br /> 
         <span id="otherfruitbalance"><?php echo ($othernumber); ?></span>
       </div> 
      </div> 
      <div style="height: 10px;text-align: right;float:right;">
       <!--<a href="" onclick=""><img src="/Public/images/home/exchange.png" /></a>-->
...
<div id="bottomright"  style="position: absolute; width: 100px;height: 20px;right: 40px; bottom: 33px;padding: 5px;z-index: 1;"><a href="<?php echo U('Index/fram');?>"><img class="home" onclick="" src="/Public/images/home/home1.png"></a></div>
    <div class="plate"> 
